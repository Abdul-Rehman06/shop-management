...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $openingStock = trim((string) ($_POST['opening_stock'] ?? ''));
        ...
        <form method="post">
            <div class="row g-3">
                ...
                <div class="col-12 col-md-3">
                    ...
                    <input class="form-control" type="number" step="1" min="0" id="opening_stock" name="opening_stock" value="<?= h($openingStock) ?>" required>
                </div>
                <div class="col-12 col-md-3">
                    <label class="form-label" for="low_stock_limit">Low Stock Limit</label>
                    <input class="form-control" type="number" step="1" min="0" id="low_stock_limit" name="low_stock_limit" value="<?= h($lowStockLimit) ?>" required>
                </div>
            </div>
