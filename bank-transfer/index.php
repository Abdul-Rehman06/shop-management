...
<div class="d-flex flex-wrap gap-2 align-items-center justify-content-between mb-3">
    ...
    <div class="d-flex flex-wrap gap-2">
        ...
        <a class="btn btn-outline-primary btn-sm" href="<?= h(app_url('bank-transfer/receiving.php')) ?>">Add Received</a>
        <a class="btn btn-primary btn-sm" href="<?= h(app_url('bank-transfer/sending.php')) ?>">Add Sent</a>
    </div>
</div>
    ...
    <div class="col-12 col-md-3">
        <div class="card border-0 shadow-sm">
            <div class="card-body">
                ...
                <div class="h5 mb-0"><?= h(number_format($totals['received'], 2)) ?></div>
            </div>
        </div>
    </div>
    <div class="col-12 col-md-3">
        <div class="card border-0 shadow-sm">
            <div class="card-body">
                ...
                <div class="h5 mb-0"><?= h(number_format($totals['sent'], 2)) ?></div>
            </div>
        </div>
    </div>
    <div class="col-12 col-md-3">
    ...
    <div class="col-12 col-md-3">
        <div class="card border-0 shadow-sm">
            <div class="card-body">
                ...
                <div class="h5 mb-0"><?= h(number_format($totals['charges'], 2)) ?></div>
            </div>
        </div>
    </div>
</div>
