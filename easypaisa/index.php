...
<div class="d-flex flex-wrap gap-2 align-items-center justify-content-between mb-3">
    ...
    <div class="d-flex flex-wrap gap-2">
        ...
        <a class="btn btn-outline-primary btn-sm" href="<?= h(app_url('easypaisa/receiving.php')) ?>">Add Receiving</a>
        <a class="btn btn-primary btn-sm" href="<?= h(app_url('easypaisa/sending.php')) ?>">Add Sending</a>
    </div>
</div>
