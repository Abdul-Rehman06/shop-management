...
$pageTitle = 'EasyPaisa Opening Balance - Shop Management';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!$validAccount) {
        ...
        app_redirect('easypaisa/index.php?account_id=' . $accountId);
    }
}
...
<div class="d-flex align-items-center justify-content-between mb-3">
    <h1 class="h4 mb-0">EasyPaisa Opening Balance</h1>
    <a class="btn btn-outline-secondary btn-sm" href="<?= h(app_url('easypaisa/index.php?account_id=' . $accountId)) ?>">Back</a>
</div>
